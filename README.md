...
This program is a front-end for DOSBox-Staging with an emphasis on preserving many different aspects of the DOS gaming experience era, like access to manuals, box art, original distribution media and providing an easy way to manage games isolated from each other.
